...
// Auto redirect jika sudah login dan belum lebih dari 10 menit
if (
    isset($_SESSION['admin_logged_in']) &&
    $_SESSION['admin_logged_in'] === true &&
    isset($_SESSION['login_time']) &&
    (time() - $_SESSION['login_time']) < 600 // 600 detik = 10 menit
) {
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($user && password_verify($password, $user["password"])) {
        ...
        $_SESSION["login_time"] = time(); // waktu saat login
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>The Rinra - Luxury Hotel & Lifestyle in Makassar</title>
  ...
  <body>
    ...
    <!-- Login Form -->
    <div data-aos="zoom-in-up" class="wrapper" style="margin-top: 100px">
      <h2>Login</h2>
      <?php if (!empty($error)): ?>
